...
public static class HarmonyPatches
{
    ...
    {
        var harmony = new Harmony("AR_jecstools.chjees.shields");
        ...
        harmony.Patch(AccessTools.Method(typeof(Pawn_HealthTracker), nameof(Pawn_HealthTracker.PreApplyDamage)),
            new HarmonyMethod(type, nameof(Patch_Pawn_HealthTracker_PreApplyDamage)));
    ...
    public static void Patch_PawnRenderer_RenderPawnAt(Pawn ___pawn)
    {
        //Render shield.
